<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      <img
        ...
        class="content-image"
      />
      <div class="header-content" @click="isShowBulletin = !isShowBulletin">
    ...
    <div class="shop-header-discounts" v-if="info.name" @click="isShowActive =!isShowActive">
  ...
  <transition name="fade">
    ...
    <div class="activity-sheet" v-show="isShowActive">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">优惠活动</h2>
        <ul class="list">
          <li class="activity-item" :class="classArr[support.type]" v-for="(support,index) in info.supports" :key="index">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-close" @click="isShowActive =!isShowActive"></span>
        </div>
      </div>
      <div class="activity-sheet-cover" @click="isShowActive =!isShowActive"></div>
    </div>
    </transition>
  </div>
</template>
